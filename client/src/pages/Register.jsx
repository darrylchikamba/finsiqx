    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', animation: 'fadeInUp 0.5s ease-out 0.2s both' }}>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '12px', color: 'var(--color-text-secondary)' }}>Full name</label>
            <input
              type="text"
              value={username}
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '12px', color: 'var(--color-text-secondary)' }}>Monthly take-home income (R)</label>
            <input
              type="number"
              value={monthlyIncome}
